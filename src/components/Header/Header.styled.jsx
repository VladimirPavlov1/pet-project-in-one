...
${({isOpen,screenWidth})=>
    ...
    `border-radius:0;
     ...
     width:100%;
     height:100%;
     transition:border-radius 750ms 450ms cubic-bezier(0.23, 1, 0.32, 1), top 0ms 250ms cubic-bezier(0.23, 1, 0.32, 1), right 350ms 700ms cubic-bezier(0.23, 1, 0.32, 1), transform 0ms 250ms ease, width 650ms 250ms cubic-bezier(0.23, 1, 0.32, 1), height 650ms 250ms cubic-bezier(0.23, 1, 0.32, 1);
     `
}
